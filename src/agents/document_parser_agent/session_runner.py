...
async def run_demo():
    ...
    await session_service.create_session(
        ...
        user_id=USER_ID,
        session_id=session_id,
        state={"parser:active_category": "legal"},
    )
    ...
    await invoke(
        session_id,
        f"Parse {SAMPLE_PDF}. Include chunk bounding boxes in the result.",
    )
    ...
    await invoke(
        session_id,
        f"Parse {SAMPLE_PDF} again. For this call only: suppress 'header' and 'footer' "
